...
namespace WorldEdit.Commands
{
    public class SPaste : WECommand
    {
        ...
        public SPaste(int x, int y, ServerPlayer plr, int alignment, Expression expression, bool tiles, bool tilePaints, bool emptyTiles, bool walls, bool wallPaints, bool wires, bool liquids)
        ...
        {
            var clipboardPath = Tools.GetClipboardPath(plr.Account.AccountId);
